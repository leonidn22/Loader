...
data_dir = '/data/vftrk/'
# exceptions
exceptions = '%sexceptions/exception.log' % data_dir
# rejected
rejected = '%srejected/rejected.log' % data_dir
# loader log file
...
#data from Data Mediator
    "data_dir": "/data/vftrk/",
# exceptions
    "exceptions": "/data/vftrk/exceptions/exception.log",
# rejected
    "rejected": "/data/vftrk/rejected/rejected.log",
# loader log file
    "loader_log": "/opt/allot/vftrk/logs/loader.log",
    "csv_file_prefix": "vftrk",
    "ipquery_csv_file_path": "/opt/allot/vftrk/csv/",
